...
// import { useUser } from '@/contexts/UserContext';//will use this soon


export default function Home() {
  const [isLoggedIn, setIsLoggedIn] = useState<boolean>(false);

// const { user }:any = useUser(); //will use this soon
  ...
  return (
    <main className="flex w-full min-h-screen items-stretch justify-center">
      ...
      <div className="flex flex-col w-full min-h-screen bg-cover" style={{ backgroundImage: "url('/path_to_your_background_image.jpg')" }}>
        <div className="flex-1 flex items-center justify-center p-8 ">  {/* Adjust top padding here */}
        ...
        <div className="flex-1 flex items-center justify-center p-8 ">  {/* Adjust bottom padding here */}
